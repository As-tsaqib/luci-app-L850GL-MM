...
LuCI 1.0.0 frontend for the schema-4 `l850gl.mm` companion API. It installs
...
standard cell scan is independently gated from mutation. Firmware whose typed
responses pass runtime protocol validation can use the fixed
set/clear/reprobe/verification state machine; unrecognized protocols remain
fail-closed. Expert scans are single-flight
