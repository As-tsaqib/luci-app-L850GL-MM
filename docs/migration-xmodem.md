...
Before installing 0.6.0-r5, stop and disable the old service, then remove all
...
Install the matching checksum-verified 0.6.0-r5 pair only after the retirement
checks above pass:
