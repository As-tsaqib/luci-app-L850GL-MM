...
The v1.0.0-r3 release publishes twelve target-specific expert bundles and no
base release asset:
...
the dated record; that hardware result is not generalized to the other eleven
